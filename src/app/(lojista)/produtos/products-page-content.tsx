  ...
  return (
    <div className="w-full space-y-8">
      ...
      <div className="rounded-2xl border border-zinc-800/60 bg-zinc-900/50 p-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div className="flex-1">
            <h1 className="text-2xl font-semibold text-white mb-2">Produtos</h1>
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-zinc-700 bg-zinc-800 px-4 py-2.5 text-sm font-semibold text-zinc-200 transition hover:bg-zinc-700"
            >
      ...
      <div className="rounded-2xl border border-zinc-800/60 bg-zinc-900/50 p-6 overflow-hidden">
        <div className="mb-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="inline-flex items-center gap-1.5 rounded-full bg-zinc-500/10 px-3 py-1 text-xs font-medium text-zinc-400">
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <input
              ...
              className="w-full rounded-lg border border-zinc-700/60 bg-zinc-800/60 px-4 py-2.5 pl-10 text-sm text-zinc-200 placeholder:text-zinc-500 focus:border-indigo-400 focus:outline-none"
            />
            <svg
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="rounded-2xl border border-zinc-800/60 bg-zinc-900/50 p-6">
          <div className="mb-2 flex items-center gap-2">
            <span className="text-xs font-semibold uppercase tracking-wider text-indigo-400">MANUAL</span>
          </div>
          <h3 className="text-lg font-semibold text-white mb-2">Cadastro manual de produto</h3>
          ...
          <div className="flex gap-2">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-zinc-700 bg-zinc-800 px-4 py-2 text-sm font-medium text-zinc-200 transition hover:bg-zinc-700"
            >
              Abrir formulário
            </button>
        ...
        <div className="rounded-2xl border border-zinc-800/60 bg-zinc-900/50 p-6">
          <h4 className="text-sm font-semibold text-white mb-3">Campos sugeridos</h4>
          <ul className="space-y-2 text-sm text-zinc-400">
            <li className="flex items-start gap-2">
              <CheckCircle2 className="h-4 w-4 mt-0.5 text-indigo-400 flex-shrink-0" />
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="rounded-2xl border border-zinc-800/60 bg-zinc-900/50 p-6">
          <div className="mb-2 flex items-center gap-2">
            <span className="text-xs font-semibold uppercase tracking-wider text-emerald-400">IMPORTAÇÃO</span>
          </div>
          <h3 className="text-lg font-semibold text-white mb-2">Importar produtos em massa</h3>
          <p className="text-sm text-zinc-400 mb-4">
        ...
        <div className="rounded-2xl border border-emerald-500/30 bg-emerald-500/10 p-6">
          <h4 className="text-sm font-semibold text-white mb-2">Conecte seu e-commerce</h4>
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-emerald-400/40 bg-emerald-500/20 px-4 py-2 text-sm font-medium text-emerald-200 transition hover:bg-emerald-500/30"
          >
            Quero ser avisado
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-zinc-700 bg-zinc-800 px-3 py-2 text-sm text-zinc-100 focus:border-indigo-400 focus:outline-none"
                />
              </div>
              <div>
                <label className="block text-xs font-medium text-zinc-400 mb-1">Plataforma de interesse</label>
                <select className="w-full rounded-lg border border-zinc-700 bg-zinc-800 px-3 py-2 text-sm text-zinc-100 focus:border-indigo-400 focus:outline-none">
