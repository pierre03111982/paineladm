...
export function DashboardContent({ data, lojistaId, lojaLogo = null, lojaNome, initials = "EA" }: DashboardContentProps) {
  ...
  // Estilos forçados apenas para cards de produto e elementos com data-force-white
  useEffect(() => {
    const forceStyles = () => {
  ...
  return (
    <div className="dashboard-page space-y-3 pb-6 min-w-0 max-w-full overflow-visible" style={{ backgroundColor: "transparent" }}>
      {/* Header do Dashboard */}
      ...
      >
        ...
        <motion.div
          ...
          style={{ boxShadow: "0 8px 16px rgba(0, 0, 0, 0.4), 0 4px 8px rgba(0, 0, 0, 0.3)" }}
        >
