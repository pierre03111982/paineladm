        ...
        <aside className="hidden w-64 flex-col rounded-2xl md:rounded-3xl border border-zinc-800/60 bg-zinc-900/70 p-4 md:p-6 shadow-[0_25px_80px_-45px_rgba(79,70,229,0.65)] backdrop-blur-xl md:flex lojista-content">
          <div className="mb-8 space-y-2">
            ...
            <div>
              ...
              <h2 className="text-lg font-semibold text-white" id="sidebar-loja-nome">
                {perfil?.nome || ""}
              </h2>
          ...
          <div className="mt-auto rounded-2xl border border-indigo-500/20 bg-indigo-500/10 p-4">
            ...
            <Link
              ...
              className="mt-3 inline-flex items-center justify-center rounded-lg bg-indigo-500 px-3 py-2 text-xs font-semibold text-white transition hover:bg-indigo-400"
            >
